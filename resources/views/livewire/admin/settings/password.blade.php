<section class="w-full">
    ...
    <x-layouts.admin.settings.layout :heading="__('Update password')" :subheading="__('Ensure your account is using a long, random password to stay secure')">
    ...
    </x-layouts.admin.settings.layout>
</section>
