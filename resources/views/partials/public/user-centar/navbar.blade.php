<flux:navbar class="mb-5">
    @can(abilities: 'view.post')
        <flux:navbar.item
            ...
            :current="request()->routeIs('user.center.index')"
            wire:navigate
        >
            Posts
        </flux:navbar.item>
    ...
    @can(abilities: 'create.post')
        <flux:navbar.item
            ...
            :current="request()->routeIs('user.posts.create')"
            wire:navigate
        >
            New post</flux:navbar.item>
    @endcan

    @can(abilities: 'view.comment')
        <flux:navbar.item
            :href="route('user.center.comments')"
            :current="request()->routeIs('user.center.comments')"
            wire:navigate
        >
